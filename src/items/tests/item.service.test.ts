...
describe('Item Service', () => {
  ...
  describe('createItem', () => {
    ...
    it('should require authentication', async () => {
      ...
      await expect(createItem(itemData, null)).rejects.toThrow('Authentication required')
    })
  ...
  describe('findItemById', () => {
    ...
    it('should require authentication for private items', async () => {
      ...
      // Try to access private item without authentication (null user)
      await expect(findItemById(createdItem.id, null)).rejects.toThrow(
  ...
  describe('deleteItem', () => {
    ...
    it('should prevent deletion of items in character inventories', async () => {
      ...
      const _character = await db.character.create({
        data: {
