...
describe('RBAC Service', () => {
  ...
  describe('canAccessByVisibility', () => {
    describe('PUBLIC visibility', () => {
      ...
      it('should allow access for unauthenticated users', () => {
        expect(canAccessByVisibility(undefined, publicResource)).toBe(true)
      })
    })
    ...
    describe('PRIVATE visibility', () => {
      ...
      it('should deny access for unauthenticated users', () => {
        expect(canAccessByVisibility(undefined, privateResource)).toBe(false)
      })
    })
    ...
    describe('HIDDEN visibility', () => {
      ...
      it('should deny access for unauthenticated users', () => {
        expect(canAccessByVisibility(undefined, hiddenResource)).toBe(false)
      })
    })
  ...
  describe('canDeleteResource', () => {
    ...
    it('should deny unauthenticated users', () => {
      expect(canDeleteResource(undefined, mockResource)).toBe(false)
    })
  })
  ...
  describe('canCreateForUser', () => {
    ...
    it('should deny unauthenticated users', () => {
      expect(canCreateForUser(undefined, 'user-123')).toBe(false)
    })
  })
  ...
  describe('canAccessUserProfile', () => {
    ...
    it('should deny unauthenticated users', () => {
      expect(canAccessUserProfile(undefined, 'user-123')).toBe(false)
    })
  })
  ...
  describe('canModifyUserProfile', () => {
    ...
    it('should deny unauthenticated users', () => {
      expect(canModifyUserProfile(undefined, 'user-123')).toBe(false)
    })
  })
  ...
  describe('canAccessAdminFeatures', () => {
    ...
    it('should deny unauthenticated users', () => {
      expect(canAccessAdminFeatures(undefined)).toBe(false)
    })
  })
  ...
  describe('canAccessModeratorFeatures', () => {
    ...
    it('should deny unauthenticated users', () => {
      expect(canAccessModeratorFeatures(undefined)).toBe(false)
    })
  })
  ...
  describe('canViewStatistics', () => {
    ...
    it('should deny unauthenticated users', () => {
      expect(canViewStatistics(undefined)).toBe(false)
    })
  })
  ...
  describe('enforceAuthentication', () => {
    ...
    it('should throw UnauthorizedError when user is null', () => {
      expect(() => enforceAuthentication(undefined)).toThrow('Authentication required')
    })
  })
  ...
  describe('filterVisibleResources', () => {
    ...
    it('should filter resources for unauthenticated user', () => {
      const filtered = filterVisibleResources(undefined, resources)
  ...
  describe('getOwnershipFilter', () => {
    it('should return public-only filter for unauthenticated users', () => {
      const filter = getOwnershipFilter(undefined)
